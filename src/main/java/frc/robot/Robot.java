...
public class Robot extends TimedRobot {
	...
	public void addTestingCommands() {
		...
		m_testingChooser
				.addOption(
						"Pick Up and Score Left at Level 4 (6, 7, 8, 9, 10, 11)",
						testAlignment(
								4, 0.1, 1.5, 3.0, kRobotToTagsLeft,
								6, 7, 8, 9, 10, 11));
		m_testingChooser
				.addOption(
						"Pick Up and Score Right at Level 4 (6, 7, 8, 9, 10, 11)",
						testAlignment(
								4, 0.1, 1.5, 3.0, kRobotToTagsRight,
								6, 7, 8, 9, 10, 11));
		m_testingChooser
				.addOption(
						"Pick Up and Score Left at Level 4 (17, 18, 19, 20, 21, 22)",
						testAlignment(
								4, 0.1, 1.5, 3.0, kRobotToTagsLeft,
								17, 18, 19, 20, 21, 22));
		m_testingChooser
				.addOption(
						"Pick Up and Score Right at Level 4 (17, 18, 19, 20, 21, 22)",
						testAlignment(
								4, 0.1, 1.5, 3.0, kRobotToTagsRight,
								17, 18, 19, 20, 21, 22));
		m_testingChooser
